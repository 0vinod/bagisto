...
Route::get('order-thank-you/{order}', [OrderController::class, 'thankyou'])->name('order.thankyou');
...
Route::group(['prefix' => '/admin', 'middleware' => ['auth', 'admin']], function () {
    ...
    Route::any('/shipping_policies', [ShippingController::class, 'shippingPolicies'])->name('backend.shipping.policies');
});
...
Route::get('/load-more-products', [FrontendController::class, 'loadMore'])->name('products.loadmore');
