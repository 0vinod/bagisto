                                ...
                                <div class="cart-table">
                                    ...
                                    <div class="cart-body" id="cart_item_list">
                                        @foreach (Helper::getAllProductFromCart() as $key => $cart)
                                            ...
                                            @endphp
                                            <div class="cart-item" data-cart-id="{{ $cart->id }}" data-product-id="{{ $cart->product_id }}">
                                                ...
                                                <div class="cart-col action-col">
                                                    <a href="{{ route('cart-delete', $cart->id) }}" class="remove-item" title="Remove Item">
                                                        <i class="ti-trash"></i>
                                                    </a>
                                                </div>
                                            </div>
...
.cart-table {
    width: 100%;
    min-width: 768px; /* Prevents breaking on medium screens */
}
