                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">Rs. {{ number_format(($item->price ?? 0) * $item->quantity, 2) }}</td>
                                </tr>
                                @endforeach
                            </tbody>
                            <tfoot>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">Rs. {{ number_format($order->shipping_price ?? 0, 2) }}</td>
                                </tr>
                                @endif
                                @if($order->coupon > 0)
                                <tr>
                                    <td colspan="3" class="text-end"><strong>Coupon Discount:</strong></td>
                                    <td class="text-end text-success">-Rs. {{ number_format($order->coupon, 2) }}</td>
                                </tr>
                                @endif
                                <tr class="bg-light">
                                    <td colspan="3" class="text-end"><strong>Total Amount:</strong></td>
                                    <td class="text-end"><strong>Rs. {{ number_format($order->total_amount, 2) }}</strong></td>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
