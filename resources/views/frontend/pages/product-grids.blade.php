...
@section('main-content')
    ...
    <form action="{{ route('shop.filter') }}" method="POST" id="filterForm">
        @csrf
        <section class="modern-product-section section">
            <div class="container">
                <div class="row g-4">
                    <!-- Sidebar -->
                    ...
                    <div class="col-lg-9 col-md-8 col-12">
                        ...
                        <div class="shop-top-bar">
                            ...
                            <div class="view-mode">
                                <a href="javascript:void(0)" class="active" title="Grid View">
                                    <i class="fas fa-th-large"></i>
                                </a>
                                <a href="{{ route('product-lists') }}" title="List View">
                                ...
                                @foreach($products as $product)
                                    ...
                                    <div class="product-card">
                                        <div class="product-image">
                                            <a href="{{ route('product-detail', $product->slug) }}">
                                                <img class="primary-img" src="{{ $photo[0] }}" alt="{{ $product->title }}">
                                                @if(count($photo) > 1)
                                                    <img class="hover-img" src="{{ $photo[1] }}" alt="{{ $product->title }}">
                                                @endif
                                            </a>
                                            @if($product->discount)
                                        ...
                                        <form action="{{ route('single-add-to-cart') }}" method="POST" class="add-to-cart-form">
                                            ...
                                            <div class="quantity-selector">
                                                ...
                                                <div class="quantity-controls">
                                                    ...
                                                    <input type="text" name="quant[1]" class="quantity-input" value="1" min="1" max="1000">
